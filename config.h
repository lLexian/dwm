...
static const char col_gray4[]       = "#222222";	/* current tag and window font colour */
static const char col_cyan[]        = "#8a659f";	/* top bar second colour and active window border colour */
